...
/**
 * Consumes messages from one or more topics in Kafka and does wordcount. 消费kafka来的一个或多个主题并做词频统计
 ...
 *
 * Example:
 *    `$ bin/run-example sql.streaming.JavaStructuredKafkaWordCount host1:port1,host2:port2 subscribe topic1,topic2`
 */
